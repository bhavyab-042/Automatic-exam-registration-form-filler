...
#    Dec 17, 2020 01:43:14 PM IST  platform: Windows NT
...
class Toplevel1:
    def shownstudents(self):
        connection = mysql.connector.connect(host='localhost',
                                             database='aef_database',
                                             user='root',
                                             password='toor')
        q="select * from hall_ticket"
        sql_select_Query=q
        cursor = connection.cursor()
        cursor.execute(sql_select_Query)
        records = cursor.fetchall()
        ns=(cursor.rowcount)
        self.ednslb.delete(0, self.ednslb.size())
        self.ednslb.insert(ns)
        connection.close()
        cursor.close()
    def scheduleexamfun(self):
        ccode = self.edcctb.get('1.0', 'end')
        ccode=str.rstrip(ccode)
        edate = self.ededtb.get('1.0', 'end')
        edate=str.rstrip(edate)
        #MongoDB code to add exam schedule....
        connection=pymongo.MongoClient('localhost', 27017)
        database = connection['aef_database']
        collection = database['exam_schedule']
        data={'course_code':ccode,'exam_date':edate}
        collection.insert_one(data)

        
        tkMessageBox.showerror("Success", "Exam scheduled successfully.")
    def showexamscheduled():
        #MongoDB code to retrive course code and exam DATE
        mydoc=collection.find()
        for x in mydoc:
            cc=x['course_code']
            ed=x['exam_date']
        self.edslb.delete(0, self.edslb.size())
        self.edslb.insert(records_retrived)
    def logoutfun(self):
        quit()
    def showexamform(self):
        tkMessageBox.showerror("Success", "Put code to show exam form.")
    def addexamcentrefun(self):
        tkMessageBox.showerror("Success", "Exam centre added successfully.")
    def rmexamcentre(self):
        tkMessageBox.showerror("Success", "Exam centre removed successfully.")
    def __init__(self, top=None):
        ...
        self.edshowbtn.configure(command=self.shownstudents,text='''Show''')
        ...
        self.edsebtn.configure(command=self.scheduleexamfun,text='''SCHEDULE EXAM''')
        ...
        self.edshowsbtn.configure(command=self.showexamscheduled,text='''SHOW EXAMS SCHEDULED''')
        ...
        self.addecbtn.configure(command=self.addexamcentrefun,text='''ADD EXAM CENTRE''')
        ...
        self.Text5.place(relx=0.728, rely=0.776, relheight=0.045, relwidth=0.135)
        ...
        self.showefbtn.configure(command=self.showexamform,text='''SHOW''')
        ...
        self.removeecbtn.configure(command=self.rmexamcentre,text='''REMOVE''')

        self.Message2 = tk.Message(self.Frame1)
        self.Message2.place(relx=0.521, rely=0.776, relheight=0.034
                , relwidth=0.198)
        self.Message2.configure(background="#d9d9d9")
        self.Message2.configure(foreground="#000000")
        self.Message2.configure(highlightbackground="#d9d9d9")
        self.Message2.configure(highlightcolor="black")
        self.Message2.configure(text='''ENTER STUDENT USN TO SEE HIS EXAM FORM :''')
        self.Message2.configure(width=346)

        self.Message3 = tk.Message(self.Frame1)
        self.Message3.place(relx=0.539, rely=0.601, relheight=0.034
                , relwidth=0.181)
        self.Message3.configure(background="#d9d9d9")
        self.Message3.configure(foreground="#000000")
        self.Message3.configure(highlightbackground="#d9d9d9")
        self.Message3.configure(highlightcolor="black")
        self.Message3.configure(text='''ENTER EXAM CENTRE CODE TO REMOVE IT :''')
        self.Message3.configure(width=315)
